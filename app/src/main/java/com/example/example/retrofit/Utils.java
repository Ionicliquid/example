...
public class Utils {
    ...
    static Class<?> getRawType(Type type) {
        ...
        if (type instanceof WildcardType) {
            return getRawType((WildcardType) ((WildcardType) type).getUpperBounds()[0]);
        }
        throw new IllegalArgumentException("Expected a class, Pjarameterzedtype,or" + "GenericArray,but<" + type +
